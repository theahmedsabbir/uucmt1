        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                                    ...
                                    <tbody>
                                        @foreach ($clubs as $club)   
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $club->email }} </td>
                                                <td>
                                                    <a href="{{ route('stuff.clubs.edit', $club->id) }}" class="badge badge-primary">
                                                        <i class="icon-note"></i>
                                                    </a>
                                                    <a href="#modal"  data-toggle="modal" data-target="#exampleModalCenter{{$club->id}}" class="badge badge-danger">
                                              ...
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    Are you sure to delete <strong>{{ $club->name }}</strong> from system? 
                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <button onclick="document.getElementById('del_form{{$club->id}}').submit()" class="btn btn-danger">Yes Delete</button>

                                                    <form method="POST" action="{{ route('stuff.clubs.delete', $club->id ) }}" id="del_form{{$club->id}}">
                                                        @csrf
                    ...
                    <a href="{{ route('stuff.clubs.create') }}" class="btn btn-primary">Add Club</a>
                </div>
            </div>
