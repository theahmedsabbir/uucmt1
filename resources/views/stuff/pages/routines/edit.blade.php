            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Edit Routine</h2>
                    </div>            
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                        	...
                        	<form action="{{ route('stuff.routines.update',$routine->id ) }}" method="POST" enctype="multipart/form-data">
                        		@csrf
	                            ...
	                            <div class="row clearfix">
	                                <div class="col-md-12 col-sm-12">
	                                    <div class="form-group">
	                                        ...
	                                        <input type="text" name="day" value="{{$routine->day}}" class="form-control" required>
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="row clearfix">
