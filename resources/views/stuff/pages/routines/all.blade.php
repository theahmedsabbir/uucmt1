                                    ...
                                    <tbody>
                                        @foreach ($routines as $routine)   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('stuff.routines.edit', $routine->id) }}" class="badge badge-primary">
                                                        <i class="icon-note"></i>
                                                    </a>
                                              ...
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="{{ route('stuff.routines.delete', $routine->id ) }}" id="del_form{{$routine->id}}">
                                                        @csrf
