                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                        <ul class="breadcrumb pull-right">
                            <li class="breadcrumb-item"><a href="{{ route('student.dashboard') }}"><i class="icon-home"></i></a></li>                            
                        ...
                        <div class="body">
                            ...
                            <div class="tab-content padding-0 mt-3">
                                <div class="tab-pane active" id="Details">
                            		...
                            		<div class="row clearfix">
                            			<div class="col-sm-12">
                            				<form action="{{ route('student.coursePosts.store') }}" method="POST" enctype="multipart/form-data">
                            					@csrf
						                            ...
						                            ">
						                                	...
						                                	<div class="col-sm-1">	 
						                                        ...
						                                        <ul class="dropdown-menu dropdown-menu-right p-3 float-right">
						                                            <li>
						                                            	...
						                                            	<form id="form_{{$post->id}}" action="{{ route('student.coursePosts.delete', $post->id ) }}" method="POST" class="d-none">
						                                            		@csrf
						                                ...
						                                <div class="msg">
						                                    ...
						                                    <div class="collapse m-t-10" id="collapseExample_{{$post->id}}">
						                                        <div class="well">
						                                            <form id="form_{{$post->id}}" action="{{ route('student.coursePosts.commentStore') }}" method="POST">
						                                            	@csrf
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
	                                ...
	                                ">
	                                    ...
	                                    <div class="row clearfix">
	                                        ...
	                                        <div class="col-sm-1">	
	                                        	...
	                                        	@if (Auth::user()->id==$comment->commentor->id)

	                                        	<form action="{{ route('student.coursePosts.commentDelete', $comment->id ) }}" method="POST">
	                                        		@csrf
		      ...
		      <div class="modal-footer d-block">
                <form action="{{ route('student.coursePosts.commentStore') }}" method="POST">
			      	<div class="row clearfix">
                                        ...
                                        <div class="col-sm-12">
				                            ...
				                            <div class="table-responsive">
				                                <table class="table table-hover m-b-0">
				                                    ...
				                                    <tbody>
				                                        @foreach ($exams->where('is_open', 1) as $exam)   
				                                            ...
				                                            <tr>
				                                                ...
				                                                <td>
				                                                    <a href="{{ route('student.exams.showAnswerSheet', $exam->id) }}" class="badge badge-success">
