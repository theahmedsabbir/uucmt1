                        ...
                        <div class="body">
                            ...
                            <div class="tab-content padding-0 mt-3">
                                <div class="tab-pane active" id="Details">
                            		...
                            		<div class="row clearfix">
                            			<div class="col-sm-12">
                            				<form action="{{ route('admin.coursePosts.store') }}" method="POST" enctype="multipart/form-data">
                            					@csrf
						                            ...
						                            ">
						                                	...
						                                	<div class="col-sm-1">	 
						                                        ...
						                                        <ul class="dropdown-menu dropdown-menu-right p-3 float-right">
						                                            <li>
						                                            	...
						                                            	<form id="form_{{$post->id}}" action="{{ route('admin.coursePosts.delete', $post->id ) }}" method="POST" class="d-none">
						                                            		@csrf
						                                ...
						                                <div class="msg">
						                                    ...
						                                    <div class="collapse m-t-10" id="collapseExample_{{$post->id}}">
						                                        <div class="well">
						                                            <form id="form_{{$post->id}}" action="{{ route('admin.coursePosts.commentStore') }}" method="POST">
						                                            	@csrf
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
                                ...
                                @foreach ($post->comments->sortByDesc('created_at') as $comment)
	                                ...
	                                ">
	                                    ...
	                                    <div class="row clearfix">
	                                        ...
	                                        <div class="col-sm-1">	
	                                        	<form action="{{ route('admin.coursePosts.commentDelete', $comment->id ) }}" method="POST">
	                                        		@csrf
		      ...
		      <div class="modal-footer d-block">
                <form action="{{ route('admin.coursePosts.commentStore') }}" method="POST">
			      	<div class="row clearfix">
				                                    ...
				                                    <tbody>
				                                        @foreach ($exams as $exam)   
				                                            ...
				                                            <tr>
				                                                ...
				                                                <td><span class="list-name">{{ $exam->name }}</span></td>
				                                                <td>
				                                                	@php
				                                                ...
				                                                <td>
				                                                    <a href="{{ route('admin.exams.showQuestionMaker', $exam->id) }}" class="badge badge-warning">
				                                                        <i class="icon-question"></i>
				                                                    </a>
				                                                    <a href="{{ route('admin.exams.showAnswerSheet', $exam->id) }}" class="badge badge-success">
				                                                        <i class="icon-pencil"></i>
				                                                    </a>
				                                                    <a href="#mark" class="badge badge-primary"   data-toggle="modal" data-target="#mark{{$exam->id}}">
				                                                        <i class="icon-list"></i>
				                                                    </a>
				                                                    <a href="{{ route('admin.exams.edit', $exam->id) }}" class="badge badge-primary">
				                                                        <i class="icon-note"></i>
				                                                    </a>
				                                              ...
				                                              <div class="modal-dialog modal-dialog-centered" role="document">
				                                                <div class="modal-content">
				                                                  ...
				                                                  <div class="modal-footer">
				                                                    ...
				                                                    <form method="POST" action="{{ route('admin.exams.delete', $exam->id ) }}" id="del_form{{$exam->id}}">
				                                                        @csrf
				                                                ...
				                                                <div class="modal-content">
				                                                  ...
				                                                  <div class="modal-body">
				                                                  	@if ($exam->results->count())
					                                                    ...
					                                                    <form action="{{ route('admin.exams.answerMark') }}" method="POST" id="mark_{{$exam->id}}">
					                                                    	@csrf
