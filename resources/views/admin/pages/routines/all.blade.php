                                    ...
                                    <tbody>
                                        @foreach ($routines as $routine)   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.routines.edit', $routine->id) }}" class="badge badge-primary">
                                                        <i class="icon-note"></i>
                                                    </a>
                                                    <a href="#modal"  data-toggle="modal" data-target="#exampleModalCenter{{$routine->id}}" class="badge badge-danger">
                                            ...
                                            <!-- Modal starts-->
                                            <div class="modal fade" id="exampleModalCenter{{$routine->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    Are you sure to delete <strong>{{ $routine->name }}</strong> from system? 
                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <button onclick="document.getElementById('del_form{{$routine->id}}').submit()" class="btn btn-danger">Yes Delete</button>

                                                    <form method="POST" action="{{ route('admin.routines.delete', $routine->id ) }}" id="del_form{{$routine->id}}">
                                                        @csrf
