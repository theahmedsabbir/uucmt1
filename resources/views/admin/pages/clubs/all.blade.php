        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                                    ...
                                    <tbody>
                                        @foreach ($clubs as $club)   
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $club->email }} </td>
                                                <td>
                                                    <a href="{{ route('admin.clubs.edit', $club->id) }}" class="badge badge-primary">
                                                        <i class="icon-note"></i>
                                                    </a>
                                              ...
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.clubs.delete', $club->id ) }}" id="del_form{{$club->id}}">
                                                        @csrf
                    ...
                    <a href="{{ route('admin.clubs.create') }}" class="btn btn-primary">Add Club</a>
                </div>
            </div>
