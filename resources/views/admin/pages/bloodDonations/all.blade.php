                                    ...
                                    <tbody>
                                        @foreach ($bloodDonations as $bloodDonation)                                            
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.bloodDonations.edit', $bloodDonation->id) }}" class="">
                                              ...
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.bloodDonations.delete', $bloodDonation->id ) }}" id="del_form{{$bloodDonation->id}}">
                                                        @csrf
