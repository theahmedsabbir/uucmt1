                                    ...
                                    <tbody>
                                        @foreach ($libraries as $library)   
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $library->stock }}</td>
                                                <td>
                                                    <a href="{{ route('admin.libraries.edit', $library->id) }}" class="badge badge-primary">
                                                        <i class="icon-note"></i>
                                                    </a>
                                              ...
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.libraries.delete', $library->id ) }}" id="del_form{{$library->id}}">
                                                        @csrf
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form method="POST" action="{{ route('admin.libraries.borrow', $library->id ) }}" id="borrow{{$library->id}}">
                                @csrf
                              ...
                              <tbody>
                                @foreach ($borrowed_books as $book)
                                    <tr>
                                      ...
                                      <td>
                                        <form action="{{ route('admin.libraries.borrowDelete') }}" method="POST" style="cursor:pointer">
                                            @csrf
