                            ...
                            <div class="body">
                                ...
                                <h6 class="mb-4">{{ $course->name }}
                                    ...
                                    <div class="float-right">
                                        <a href="{{ route('teacher.courses.edit', $course->id) }}" class="">
                                ...
                                <a href="{{ route('teacher.courses.show', $course->id ) }}" class="btn btn-block  btn-success btn-simple" role="button">Go To Courseroom</a>
                            </div>
                        </div>
                    </div>
