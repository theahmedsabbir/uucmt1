...
class NoticeController extends Controller
{
    public function index(){
		...
		return view('stuff.pages.notices.all', compact('notices'));

    }

    public function create(){
		return view('stuff.pages.notices.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('stuff.notices.all');
    }

    public function edit($id){
    	$notice = Notice::find($id);
    	return view('stuff.pages.notices.edit', compact('notice'));
    }
