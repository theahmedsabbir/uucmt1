...
class BusController extends Controller
{
    public function index(){
		...
		return view('stuff.pages.busServices.all', compact('busServices'));

    }

    public function create(){
		return view('stuff.pages.busServices.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('stuff.busServices.all');
    }

    public function edit($id){
    	$busService = BusSchedule::find($id);
    	return view('stuff.pages.busServices.edit', compact('busService'));
    }
