...
class ClubController extends Controller
{
    public function index(){
		...
		return view('stuff.pages.clubs.all', compact('clubs'));

    }

    public function create(){
		return view('stuff.pages.clubs.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('stuff.clubs.all');
    }

    public function edit($id){
    	$club = Club::find($id);
    	return view('stuff.pages.clubs.edit', compact('club'));
    }
