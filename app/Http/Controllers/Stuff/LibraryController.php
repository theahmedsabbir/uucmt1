...
class LibraryController extends Controller
{
    public function index(){
		...
		$borrowed_books = Borrowed::all();
 		return view('stuff.pages.libraries.all', compact('libraries','students', 'borrowed_books'));

    }

    public function create(){
		return view('stuff.pages.libraries.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('stuff.libraries.all');
    }

    public function edit($id){
    	$library = Library::find($id);
    	return view('stuff.pages.libraries.edit', compact('library'));
    }
    ...
    public function myBooks(){
    	...
    	$borrowed_books = $student->borrowedBooks;
 		return view('stuff.pages.libraries.myBooks', compact('borrowed_books'));
