...
class ComplainController extends Controller
{
    public function index(){
		...
		return view('stuff.pages.complains.all', compact('complains'));

    }

    public function create(){
		return view('stuff.pages.complains.create');
    }
    ...
    public function edit($id){
    	...
    	return view('stuff.pages.complains.edit', compact('complain'));
    }
    ...
    public function update(Request $request, $id){
		...
		return redirect()->route('stuff.complains.all');
    }
