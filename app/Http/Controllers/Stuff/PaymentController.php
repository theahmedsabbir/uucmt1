...
class PaymentController extends Controller
{
	public function index(){
		...
		return view('stuff.pages.payments.all', compact('semesters', 'payments'));
	}

	public function create(){
		$semesters = Semester::orderBy('start_date', 'asc')->get();
		$students = User::orderBy('username', 'asc')->where('user_role', 4)->get();
		return view('stuff.pages.payments.create', compact('semesters', 'students'));
	}
    ...
    public function store(Request $request){
		...
		return redirect()->route('stuff.payments.all');
    }
    ...
    public function myPayment(){
		...
		return view('stuff.pages.payments.myPayment', compact('semesters', 'payments'));
    ...
    public function delete(Request $request, $id){
        ...
        session()->flash('my_success', 'Payment Deleted');
        return redirect()->route('stuff.payments.all');
    }
}