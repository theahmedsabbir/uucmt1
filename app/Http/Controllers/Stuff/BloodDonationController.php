...
class BloodDonationController extends Controller
{
    public function index(){
		...
		return view('stuff.pages.bloodDonations.all', compact('bloodDonations'));

    }

    public function create(){
		return view('stuff.pages.bloodDonations.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('stuff.bloodDonations.all');
    }

    public function edit($id){
    	$bloodDonation = BloodDonation::find($id);
    	return view('stuff.pages.bloodDonations.edit', compact('bloodDonation'));
    }
    ...
    public function myDonation(){
		...
		return view('stuff.pages.bloodDonations.myDonation', compact('bloodDonation'));
