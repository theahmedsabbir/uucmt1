...
class RoutineController extends Controller
{
    public function index(){
		...
		return view('teacher.pages.routines.all', compact('routines'));

    }

    public function create(){
		return view('teacher.pages.routines.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('teacher.routines.all');
    }

    public function edit($id){
    	$routine = Routine::find($id);
    	return view('teacher.pages.routines.edit', compact('routine'));
    }
