...
class BusController extends Controller
{
    public function index(){
		...
		return view('teacher.pages.busServices.all', compact('busServices'));

    }

    public function create(){
		return view('teacher.pages.busServices.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('teacher.busServices.all');
    }

    public function edit($id){
    	$busService = BusSchedule::find($id);
    	return view('teacher.pages.busServices.edit', compact('busService'));
    }
