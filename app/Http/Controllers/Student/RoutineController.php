...
class RoutineController extends Controller
{
    public function index(){
		...
		return view('student.pages.routines.all', compact('routines'));

    }

    public function create(){
		return view('student.pages.routines.create');
    }
    ...
    public function store(Request $request){
		...
		return redirect()->route('student.routines.all');
    }

    public function edit($id){
    	$routine = Routine::find($id);
    	return view('student.pages.routines.edit', compact('routine'));
    }
