...
class PaymentController extends Controller
{
	public function index(){
		...
		return view('admin.pages.payments.all', compact('semesters', 'payments'));
	}

	public function create(){
		$semesters = Semester::orderBy('start_date', 'asc')->get();
		$students = User::orderBy('username', 'asc')->where('user_role', 4)->get();
		return view('admin.pages.payments.create', compact('semesters', 'students'));
	}
    ...
    public function store(Request $request){
		...
		return redirect()->route('admin.payments.all');
    }
    ...
    public function myPayment(){
		...
		return view('admin.pages.payments.myPayment', compact('semesters', 'payments'));
