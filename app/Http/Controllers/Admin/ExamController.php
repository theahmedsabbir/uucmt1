...
class ExamController extends Controller
{
	...
	public function showQuestionMaker($id){
		$exam = Exam::find($id);
		return view('admin.pages.exams.showQuestionMaker', compact('id','exam'));
	}
	...
	public function showAnswerSheet($id){
		...
		return view('admin.pages.exams.showAnswerSheet', compact('id','exam'));
	}
	...
	public function answerStore(Request $request){
		...
		return redirect()->route('admin.courses.show', $exam->course->id);
	}
	...
	public function answerMark(Request $request){
		...
		return view('admin.pages.exams.answerMark', compact('result', 'user_id', 'exam_id','exam'));
	}
