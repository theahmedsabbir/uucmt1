...
class CourseController extends Controller
{
    ...
    public function create(){
		...
		return view('admin.pages.courses.create', compact('batches', 'teachers', 'semesters'));
    }
    ...
    public function show($id){
    	...
    	$examCount = Exam::where( 'course_id', $course->id )
    					...
    					->where( 'is_open', 1 )
    					->count();
    	return view('admin.pages.courses.show', compact('course', 'coursePosts','exams','examCount'));
    }
